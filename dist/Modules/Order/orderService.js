...
const paginationCalculation_1 = __importDefault(
  require("../../Utilities/paginationCalculation")
);
const orderInterface_1 = require("./orderInterface");
const createNewOrderInToDB = (payload) =>
...
const getAllOrderFromDB = (params, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip, sortBy, sortOrder } = (0,
    paginationCalculation_1.default)(options);
...
const getConfirmOrderFromDB = (params, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip, sortBy, sortOrder } = (0,
    paginationCalculation_1.default)(options);
    const { searchTerm } = params,
      filterData = __rest(params, ["searchTerm"]);
    const andCondition = [];
    if (searchTerm) {
      andCondition.push({
...
const getDeliveryOrderFromDB = (params, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip, sortBy, sortOrder } = (0,
    paginationCalculation_1.default)(options);
    const { searchTerm } = params,
...
const updateOrderStatus = (orderId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteOrderFromDB = (orderProductId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield Prisma_1.default.$transaction((prisma) =>
      __awaiter(void 0, void 0, void 0, function* () {
...
//Admin Data
const getAllOrderForAdmin = (params, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip, sortBy, sortOrder } = (0,
    paginationCalculation_1.default)(options);
    const { searchTerm } = params;
